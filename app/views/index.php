...
<head>
	<title>Alzheimer's Smartwatch - Tenafly High School Lemelson-MIT InvenTeam</title>
	...
	<!--[if lte IE 8]><script src="css/index/ie/html5shiv.js"></script><![endif]-->
		
	<!-- JavaScript -->
	<script src="<?php echo asset('js/tessellate/jquery.min.js'); ?>"></script>
	<script src="<?php echo asset('js/tessellate/skel.min.js'); ?>"></script>
	<script src="<?php echo asset('js/tessellate/init.js'); ?>"></script>
	
	<!-- Stylesheets -->
	<link rel="stylesheet" href="<?php echo asset('css/tessellate/skel-noscript.css'); ?>" />
	<link rel="stylesheet" href="<?php echo asset('css/tessellate/style.css'); ?>" />
	<link rel="stylesheet" href="<?php echo asset('css/tessellate/style-wide.css'); ?>" />
	<!--[if lte IE 8]><link rel="stylesheet" href="<?php echo asset('css/index/ie/v8.css'); ?>" /><![endif]-->
	<!--[if lte IE 8]><link rel="stylesheet" href="<?php echo asset('css/index/ie/v9.css'); ?>" /><![endif]-->
</head>
				...
				<div class="content dark style1 featured">
					<div class="container">
						<div class="row">
							<div class="4u">
								<section>
									<span class="feature-icon"><span class="fa fa-map-marker"></span></span>
									<header>
							...
							<div class="4u">
								<section>
									<span class="feature-icon"><span class="fa fa-warning"></span></span>
									<header>
							...
							<div class="4u">
								<section>
									<span class="feature-icon"><span class="fa fa-location-arrow"></span></span>
									<header>
						...
						<div class="row">
							...
							<div class="8u">
								<div class="row no-collapse">
									<div class="6u"><a href="http://ineedchemicalx.deviantart.com/art/You-and-I-collide-401457901" class="image full"><img src="images/index/pic01.jpg" alt="" /></a></div>
									<div class="6u"><a href="http://ineedchemicalx.deviantart.com/art/Emperor-of-the-Stars-370265193" class="image full"><img src="images/index/pic02.jpg" alt="" /></a></div>
								</div>
								<div class="row no-collapse">
									<div class="6u"><a href="http://ineedchemicalx.deviantart.com/art/Sherlockin-369847236" class="image full"><img src="images/index/pic03.jpg" alt="" /></a></div>
								...
								<div class="row no-collapse">
									<div class="6u"><a href="http://ineedchemicalx.deviantart.com/art/The-Pursuit-355003425" class="image full"><img src="images/index/pic05.jpg" alt="" /></a></div>
									<div class="6u"><a href="http://ineedchemicalx.deviantart.com/art/Cherish-320041163" class="image full"><img src="images/index/pic06.jpg" alt="" /></a></div>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- Third -->
			<section id="third" class="main">
				...
				<div class="content dark style3">
					<div class="container">
						<span class="image featured"><img src="img/index/pic07.jpg" alt="" /></span>
						<div class="row">
							<div class="4u">
